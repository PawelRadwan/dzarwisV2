...
- **Same pompy obiegowe** (domyślnie 15 min, 1–120): Pompa CO / Pompa kolektora / Obie (`samepompy`), licznik odliczający, „Zatrzymaj pompy” (`samepompy 1 1` — `0 0` nie wyłącza pracujących pomp; staną po ~1 min). Przycisk widać też, gdy pompy pracują w stanie „Gotowa” bez licznika.
