...
- Akcja z samą godziną (`<akcja czas="08:21">`) wykonuje się **codziennie**; jednorazowa wymaga `data="RRRR/MM/DD"`, ale w latach 2016–2031 kotek zapisuje rok o 16 za duży (2026 → 2042) i akcja się nie wykona ([pompa-ciepla.md](../docs/pompa-ciepla.md#pułapki)).
